...
export function useCourseProgress(userId: string, courseId: string) {
  ...
  const updateProgress = async (
    ...
    try {
      ...
      if (currentSection) {
        updates.currentSection = currentSection;
      }

      if (completedSection && !progress.completedSections.includes(completedSection)) {
        updates.completedSections = [...progress.completedSections, completedSection];
      }
